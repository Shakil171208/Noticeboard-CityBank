...
%>
        ...
        <body class="sidebar-is-expanded">
                                    ...
                                    <div class="col-md-12">
                                        <div class="bpcont">
                                            <div class="wait-overlay" style="display: none;">
                                                <div class="us-int-dis">
                                                    <img src="/applications/<%=root_directory%>/images/Spin.gif" alt="">
                                                    <div class="us-ins-vtxt">Please wait...</div>
                                                </div>
                                            </div>
                                            <form id="editNoticeForm" name="editNoticeForm" method="post"
                                                action="validateEditNoticeBoard.asp">
                                                ...
                                                <div class="cboxwrap">
                                                                                ...
                                                                                <div class="panel-body">
                                                                                    <div class="fielmnt">
                                                                                        <fieldset>
                                                                                            ...
                                                                                            <div class="uf">
                                                                                                <div class="row df">
                                                                                                   <input type="hidden" name="noticeId1" id="noticeId1" value="<%= intNoticeId1 %>">
                                                                                                    <div class="col-md-4">
                                                                                                        <div class="form-group">
                                                                                                            ...
                                                                                                            <input type="text" class="form-control" id="serialId1" name="serialId1" placeholder="Type the SL No." value="<%=intSerialId1%>"/>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="col-md-4">
                                                                                                        <div
                                                                                                            ...
                                                                                                            <input type="text" class="form-control" id="noticeTitle1" name="noticeTitle1" placeholder="Type the notice title" value="<%=strNoticeTitle1%>"/>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="col-md-4">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <input type="text" class="form-control" id="publishedDate1" name="publishedDate1" value="<%=strPublishedDate1%>"/>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="col-md-4">
                                                                                ...
                                                                                <div class="panel-body">
                                                                                    <div class="fielmnt">
                                                                                        <fieldset>
                                                                                            ...
                                                                                            <div class="uf">
                                                                                                <div class="row df">
                                                                                                  <input type="hidden" name="noticeId2" id="noticeId2" value="<%= intNoticeId2 %>">
                                                                                                    <div class="col-md-4">
                                                                                                        <div class="form-group">
                                                                                                            <label
                                                                                ...
                                                                                <div class="panel-body">
                                                                                    <div class="fielmnt">
                                                                                        <fieldset>
                                                                                            ...
                                                                                            <div class="uf">
                                                                                                <div class="row df">
                                                                                                  <input type="hidden" name="noticeId3" id="noticeId3" value="<%= intNoticeId3 %>">
                                                                                                    <div class="col-md-4">
                                                                                                        <div class="form-group">
                                                                                                            <label
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="text-center mtf">
                                                                <button type="submit" class="btn cusbtn"
                                                                    id="btnNoticesubmit"
                                                                    onClick="return validateEditNoticeBoard();">Submit</button>
                                                                <a href="/applications/<%=root_directory%>/admin/Notice/summaryNoticeView.asp"
                                                                    class="btn cusbtn ccel">Cancel</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <script type="text/javascript" src="/applications/citybank/mto/admin/js/app.js"></script>
            <script type="text/javascript" src="/applications/citybank/mto/admin/js/registration.js"></script>
